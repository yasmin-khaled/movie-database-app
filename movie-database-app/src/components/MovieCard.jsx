...
const MovieCard = ({ movie }) => {
  ...
  return (
    <div className="bg-teal-950 text-white border rounded-md p-4 shadow-lg hover:shadow-rose-200 transition-transform duration-500 transform hover:scale-105">
